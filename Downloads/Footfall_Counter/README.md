...
1\. Virtual ROI: A vertical virtual line is defined at the center of the frame (LINE\_REF\_PERCENT = 50). This line serves as the boundary for counting.
...
4\. Directional Assignment: The assignment of "Entry" or "Exit" is determined by the configured COUNT\_DIRECTION variable. For the current setup ('left\_to\_right'):
...
The code is contained in a single Jupyter Notebook (Footfall\_Counter.ipynb) and requires Python >= 3.8.
...
2\. Open and run the Footfall\_Counter.ipynb notebook.
